...
Route
  .group(() => {
    ...
    Route.get('registration/participants', 'RegistrationController.participants')
    Route.post('registration/attendance', 'RegistrationController.present')
    Route.get('registration/attendance-list', 'RegistrationController.attendance')
